...
VALID_OBIS_CODES = {
    "1-1:1.8.0",  # Total Meter reading of consumption in Wh - default for meter reading
    "1-1:1.9.0",  # Measured value of consumption in Wh in quarter hour or daily steps
    "1-1:2.8.0",  # Total Meter reading of production/feeding on selected day(s) in Wh
    "1-1:2.9.0"   # Measured value of production/feeding in Wh in quarter hour or daily steps
}
...
class RoleType(enum.Enum):
    """Possible types for the roles of bewegungsdaten"""
